...
if __name__ == "__main__":
    ds = CocoDatasetHandler('/home/laanta/sagun/segmentation/result.json', '/home/laanta/sagun/segmentation/test/')
    ds.coco2labelme()
    ds.save_labelme(ds.labelme.keys(), '/home/laanta/sagun/segmentation/c2l')
